...
public class Switcher_ex01 : MonoBehaviour
{
    ...
    void chooseHero()
    {
        ...
        if (Input.GetKeyDown("2"))
        {
            ...
            red.GetComponent<playerScript_ex01>().enabled = false;
            red.GetComponent<Rigidbody2D>().constraints = RigidbodyConstraints2D.FreezeAll;
            blue.GetComponent<playerScript_ex01>().enabled = false;
            blue.GetComponent<Rigidbody2D>().constraints = RigidbodyConstraints2D.FreezeAll;
            yellow.GetComponent<playerScript_ex01>().enabled = true;
        ...
        if (Input.GetKeyDown("3"))
        {
            ...
            red.GetComponent<playerScript_ex01>().enabled = false;
            red.GetComponent<Rigidbody2D>().constraints = RigidbodyConstraints2D.FreezeAll;
            blue.GetComponent<playerScript_ex01>().enabled = true;
